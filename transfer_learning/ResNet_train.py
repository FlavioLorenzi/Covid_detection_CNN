...
parser.add_argument('--learning_rate', type=float, default=0.001,
                    help='learning rate (default: 10^-3)')
...
def train_model(model, criterion, optimizer, scheduler, batch_szie, num_epochs= 50):
    since = time.time()
...
if __name__ == "__main__":
    ...
    model_conv.eval()
    # save model
    torch.save(model_conv, './covid_resnet101_epoch%d.pt' %args.epochs )
